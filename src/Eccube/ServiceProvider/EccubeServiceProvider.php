...
class EccubeServiceProvider implements ServiceProviderInterface
{
    ...
    public function register(BaseApplication $app)
    {
        ...
        $app['eccube.repository.product_price'] = $app->share(function () use ($app) {
            return $app['orm.em']->getRepository('Eccube\Entity\ProductPrice');
        });
        ...
        $app['form.types'] = $app->share($app->extend('form.types', function ($types) use ($app) {
            ...
            $types[] = new \Eccube\Form\Type\Admin\ProductPriceType($app);
