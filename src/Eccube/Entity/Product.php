...
class Product extends \Eccube\Entity\AbstractEntity
{
     ...
     * @return Product
     */
    public function addProductPrice(\Eccube\Entity\ProductPrice $ProductPrices)
    {
     ...
     * @param \Eccube\Entity\ProductClass $ProductPrices
     */
    public function removeProductPrice(\Eccube\Entity\ProductPrice $ProductPrices)
    {
     ...
     * Set payment_image
     *
     * @param  string  $PcImage
     * @return Payment
     */
    public function setPcImage($PcImage)
    {
        $this->pc_image = $PcImage;
     ...
     * Set payment_image
     *
     * @param  string  $SpImage
     * @return Payment
     */
    public function setSpImage($SpImage)
    {
        $this->sp_image = $SpImage;
